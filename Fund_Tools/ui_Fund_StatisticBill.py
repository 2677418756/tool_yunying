...
################################################################################
## Form generated from reading UI file 'Fund_StatisticBill.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.dateEdit.setDateTime(QDateTime(QDate(2023, 1, 1), QTime(23, 59, 59)))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"\u8054\u5408\u578b\u8ba1\u8d39\u8868", None))
