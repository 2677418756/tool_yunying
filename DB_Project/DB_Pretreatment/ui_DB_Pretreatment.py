...
################################################################################
## Form generated from reading UI file 'DB_Pretreatment.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy3.setHeightForWidth(self.InputFile.sizePolicy().hasHeightForWidth())
        self.InputFile.setSizePolicy(sizePolicy3)
        self.InputFile.setReadOnly(True)

        self.horizontalLayout_3.addWidget(self.InputFile)
        ...
        sizePolicy7.setHeightForWidth(self.dateEdit.sizePolicy().hasHeightForWidth())
        self.dateEdit.setSizePolicy(sizePolicy7)
        self.dateEdit.setDateTime(QDateTime(QDate(2022, 9, 14), QTime(0, 0, 0)))
        ...
        sizePolicy8.setHeightForWidth(self.RunButton.sizePolicy().hasHeightForWidth())
        self.RunButton.setSizePolicy(sizePolicy8)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"\u8ba2\u5355\u72b6\u6001\u8868", None))
        ...
        self.InputFile.setPlaceholderText(QCoreApplication.translate("Form", u"\u9009\u62e9\u8f93\u5165\u6587\u4ef6\u5939", None))
        ...
        self.label_5.setText(QCoreApplication.translate("Form", u"\u7edf\u8ba1\u63fd\u6536\u65e5\u671f:", None))
